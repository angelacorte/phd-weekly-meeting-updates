...
1. Publish _Field VMC_ journal (deadline: undefined, priority: high) -- Status: we have to pay, Springer is filling our form.
2. Collektive Journal (target: JSS, status **doing**)
3. Study _CLF-CBF-QP_ for period abroad -- Next step: preparing presentation for aggregate reading group (if possible).
4. Implementation of _time replication_ -- Done, missing review.
...
### Tasks and short-term goals
1. Publish _Field VMC_ journal: DONE🎉 -- Sara paid the fee, sent to me the receipt, and I sent it to Springer.
2. Collektive Journal (target: JSS, status **doing**)
3. FormaliSE26 artifact evaluation (deadline 21 December) -- status **doing**.
4. ACSOS2026 Publicity Chair tasks -- status **doing**.  
...
### Tasks and short-term goals
1. Thesis title → "Advances in Collective Robotics through macro-programming" (no updates yet)
2. Collektive Journal (target: JSS, status **paused**)
...
2. Paper on _Self-Stabilizing Gossip_ (target: Coordination, deadline: 20 February)
3. Artifact paper Gossip (target: Coordination, deadline: 27 February)
4. CAROL: Coordinated Aggregate Robotics with Online control Lyapunov and barrier functions.
5. ACSOS 2026: defined "*distributed particle filter in AC/Collektive*" (deadline: 26 Feb, status **doing**)
6. Coordination CollektiveXUnity ❓ (deadline: 20 February)
7. Read Turin's thesis about Collektive (deadline: end of February)
...
1. Collektive Journal (target: JSS, status **paused**)
2. CAROL: Coordinated Aggregate Robotics with Online control Lyapunov and barrier functions.
3. ACSOS 2026: defined "*distributed particle filter in AC/Collektive*" (deadline: 17 Apr, status **doing**)
4. Fix Echo App (deadline 20 March) *I have some questions*

### Medium-term goals
1. ACSOS Publicity Chair tasks
2. DCOSS IoT-2026 (waiting for notification: 28 march)
3. Coordination: _Self-Stabilizing Gossip_ + Artifact & CollektiveXUnity + Artifact (waiting for notification: 23 March)
4. Collektive global election is broken, I will focus on fixing it.

### Thesis students
- UniTo x Collektive (read thesis done)
- Collektive x Unity (read thesis done)
- Collektive x VMC x CBF
